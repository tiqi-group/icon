        ...
        *,
        ...
        for path in paths:
            ...
            try:
                ...
                # An unreadable file (corrupt, or busy past OPEN_TIMEOUT) must
                # not fail the RPC: the visualizer showing nothing is always
                # preferable to an error, and skipping keeps the scan moving.
